...
gammas = rnorm(1000, 0, tau**0.5) #skal denne være i annne 
#gammas
#perios 1
...
```
By simulating a thousand realisations of gammas and then computing the corresponding responses for a herd with fixed size 20 we compute the intraclass correlation between period one and two. We get a very high correlation ($0.9914$). This means that the results from period one and two resemble each other a lot. This suggests that the random variable is of great importance. 
